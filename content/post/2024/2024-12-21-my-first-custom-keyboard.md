...
ただし、作成したと言っても自分で設計したわけではなく、[Corne V4](https://shop.yushakobo.jp/products/8962?_pos=10&_sid=5609e7c92&_ss=r)という自作キーボードのキットを購入して、3Dプリンタでケースを造形したり、ファームウェアを改変したりしてカスタマイズしている形です。
