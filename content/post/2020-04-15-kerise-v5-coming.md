...
{{< postfig src="kerise-v5-model-1.png" title="KERISE v5 の3Dモデル" width="300px" >}}
...
足回りは以下のようになっていて、マウンタがホイールに食い込む形になっているため、バッテリーをエンコーダの間に配置することができました。

{{< postfig src="kerise-v5-model-3.png" title="KERISE v5 の足回り (車軸断面)" width="300px" >}}
{{< postfig src="kerise-v5-model-2.png" title="KERISE v5 の足回り (車軸断面)" width="300px" >}}

重い部品が機体中央に寄っているので、慣性モーメントが小さく、回転しやすくなっています。

重量も8.72gと軽量なので、回転・並進ともに低慣性と言えるでしょう。
